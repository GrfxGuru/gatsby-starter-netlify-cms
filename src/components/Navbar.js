				...
				<div className="container">
					...
					<div id="navMenu" className="navbar-menu">
						...
						<div className="navbar-end has-text-centered">
							<a className="navbar-item" href="https://www.linkedin.com/in/peterwitham" target="_blank" rel="noopener noreferrer">
								<span className="icon">
									<img src={linkedin} alt="LinkedIN" />
								</span>
							</a>
							<a className="navbar-item" href="https://twitter.com/compileswift" target="_blank" rel="noopener noreferrer">
								<span className="icon">
									<img src={twitter} alt="Twitter" />
								</span>
							</a>
							<a className="navbar-item" href="https://github.com/GrfxGuru" target="_blank" rel="noopener noreferrer">
								<span className="icon">
